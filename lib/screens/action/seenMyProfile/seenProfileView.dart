...
import 'interfaces/seenProfileViewInterface.dart';
import 'seenProfileController.dart';

class SeenProfileView extends GetView<SeenProfileController> implements SeenProfileViewInterface {
  const SeenProfileView({super.key});
